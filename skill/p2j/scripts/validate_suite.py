...
REQUIRED_BEHAVIOR_CASES = {
    ...
    "A38_USAGE_REPORTING",
    "A39_BRIEF_PRIVATE_DEFENSE",
    "A40_BRIEF_COMPANY_PREREQUISITE",
    "A41_ADDED_FILE_INVALIDATION",
    "A42_JD_MAP_COMPANY_KEY",
    "A43_EXACT_TRACK_REUSE",
    "A44_STATEFUL_PLANNER_BOUNDARY",
    "A45_TWO_JD_END_TO_END",
}
