...
2. Start with `Mock Interview — simulated practice`, visibly labeling the
...
4. Continue through at least three follow-up levels unless the user stops or the
   evidence boundary is already clear.
5. End the round with an updated answer-bank entry: confirmed facts, corrections,
