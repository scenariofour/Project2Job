...
| **Agent** | The future stateful product that actively detects project change, maintains corrections and dependencies, and regenerates affected outputs with a change explanation. | A Skill, the passive Context Registry, or the Day 1 loop slice. | `docs/06_AGENT_PRODUCT_SPEC.md` |
