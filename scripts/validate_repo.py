...
REQUIRED = [
    ...
    "lab/day5/cases.jsonl",
    "lab/day5/capture_manifest.json",
    "lab/day5/results.json",
    "lab/day5/bad_cases.jsonl",
    "lab/day5/blind_review_packet.md",
    "scripts/run_day5_evaluation.py",
    "lab/evals/day3_context_cases.jsonl",
    "docs/build_journal/traces/day3_context_comparison.json",
    "scripts/run_day3_context_comparison.py",
